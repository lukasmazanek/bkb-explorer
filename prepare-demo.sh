...
echo "🔐 BKB Explorer - Preparing organization data (private, never committed)..."
echo ""
...
echo "};" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
echo "console.log('🔐 Organization data loaded:', Object.keys(window.BKB_ORG_DATA));" >> "$OUTPUT_FILE"
