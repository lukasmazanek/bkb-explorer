...
#
# For RBCZ data, run ./prepare-demo.sh (generates data-rbcz.js, gitignored)
#
...
echo "📦 BKB Explorer - Preparing test data (public, committed)..."
echo ""
...
echo ""
echo "📦 This file is committed to the repository."
echo "🔐 For RBCZ data, run: ./prepare-demo.sh"
